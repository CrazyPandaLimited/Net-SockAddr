...
namespace xs {
    template <class TYPE> struct Typemap<panda::net::SockAddr*, TYPE> : TypemapBase<panda::net::SockAddr*, TYPE> {
        ...
        static Sv create (pTHX_ const panda::net::SockAddr* var, const Sv& = {}) {
    ...
    template <> struct Typemap<panda::net::SockAddr> : TypemapBase<panda::net::SockAddr> {
        ...
        static Sv create (pTHX_ const panda::net::SockAddr& var, const Sv& = {}) { return xs::net::_create_sockaddr(aTHX_ var); }
    };
}
