...
Binary IPv4 address for listening all interfaces on machine.
...
Binary IPv4 address for loopback interface
...
IPv4 sockaddr for listening all interfaces on machine.
...
IPv4 sockaddr for loopback interface. The same as

    Net::SockAddr::Inet4->new(Net::SockAddr::INADDR_LOOPBACK, 0);

=item IN6ADDR_ANY

Binary IPv6 address for listening all interfaces on machine.

=item IN6ADDR_LOOPBACK

Binary IPv6 address for loopback interface

=item SOCKADDR6_ANY

IPv6 sockaddr for listening all interfaces on machine.
...
IPV6 sockaddr for loopback interface. The same as
